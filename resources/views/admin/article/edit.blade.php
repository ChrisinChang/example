                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="cate_id">
                                @foreach($data as $d)
                                <option value="{{$d->cate_id}}" {{($field->cate_id == $d->cate_id)? 'selected' : ""}}>{{$d->_cate_name}}</option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>文章內容：</th>
                        <td>
                            <textarea id="art_content" name="art_content" class="ckeditor">{{$field->art_content}}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
